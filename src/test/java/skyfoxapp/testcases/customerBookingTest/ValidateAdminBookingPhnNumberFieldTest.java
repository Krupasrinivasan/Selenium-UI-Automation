...
public class ValidateAdminBookingPhnNumberFieldTest extends BaseTest {
    ...
    public void customerBookingTest(String username, String password,String seats,String name,String number,String email) throws InterruptedException {
        ...
        sleep();
        String phNumberErrorMsg = customerBookingPage.returnPhoneNumberMsg();
        Assert.assertTrue(phNumberErrorMsg.contains("Phone number should be 10 digits"),"The phone number message mismatch");
    }
