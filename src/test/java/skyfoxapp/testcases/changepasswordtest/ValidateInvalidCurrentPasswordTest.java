...
public class ValidateInvalidCurrentPasswordTest extends BaseTest {
    ...
    public void changePasswordTest(String username,String password,String oldPassword,String newPassword,String confirmPassword) throws InterruptedException {
        ...
        Assert.assertTrue(failureMessage.contains("Invalid current password"),"Invalid current passsword message mismatch");
