...
public class PreviousDayAvailableSlotsScheduleTest extends BaseTest {
    ...
    public void scheduleMovieTest(String username, String password) throws InterruptedException {
        ...
        driver.navigate().to("http://ec2-65-2-126-57.ap-south-1.compute.amazonaws.com:3000/shows?date=2022-07-06");
