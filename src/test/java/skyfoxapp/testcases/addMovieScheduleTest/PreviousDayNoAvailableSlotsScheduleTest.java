...
public class PreviousDayNoAvailableSlotsScheduleTest extends BaseTest {
    ...
    public void scheduleMovieTest(String username, String password) throws InterruptedException {
        ...
        driver.navigate().to("http://ec2-65-2-126-57.ap-south-1.compute.amazonaws.com:3000/shows?date=2022-08-06");


        System.out.println("new page");
        Thread.sleep(3000);
        boolean result = AddMovieSchedulePage.clickScheduleButton();
        Assert.assertFalse(result, "The schedule button is clickable for past days");
